...
class ExportQuakeMap(bpy.types.Operator, ExportHelper):
    ...
    def texdata(self, face, mesh, obj, orig_obj):
        ...
        rotation_layer = mesh.faces.layers.float.get("brush_rot")
...
def add_convex_hull_node(node_group):
    node_group.interface.new_socket("Material", socket_type="NodeSocketMaterial", in_out='INPUT')
    ...
    node_group.links.new(input_node.outputs['Geometry'], join_geometry_node.inputs['Geometry'])
    node_group.links.new(set_mat_node.inputs['Geometry'], join_geometry_node.outputs['Geometry'])
    node_group.links.new(set_mat_node.inputs['Material'], input_node.outputs['Material'])
    
    node_group.links.new(set_mat_node.outputs['Geometry'], store_node.inputs['Geometry'])
...
class ConvexHullBrush(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if context.scene.trenchcoat_props.automerge:
            ...
            active_object.modifiers["ConvexHullBrush"]["Socket_2"] = material
            active_object.modifiers["ConvexHullBrush"]["Socket_3"] = 1.0
            ...
            for obj in selected_objects:
                ...
                obj.modifiers["ConvexHullBrush"]["Socket_2"] = material
                obj.modifiers["ConvexHullBrush"]["Socket_3"] = 1.0
...
class FillWithBrush(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if context.mode == 'OBJECT':
            ...
            new_obj.modifiers["ConvexHullBrush"]["Socket_2"] = material
            new_obj.modifiers["ConvexHullBrush"]["Socket_3"] = 1.0
            new_obj.name = 'brush'              
    ...
    def execute(self, context):
        ...
        try:
            if active_object.modifiers["ConvexHullBrush"]:
                material = active_object.modifiers["ConvexHullBrush"]["Socket_2"]
                active_object.modifiers["ConvexHullBrush"]["Socket_3"] = 1.0
        except:
               material = context.scene.trenchcoat_props.material
    ...
    def execute(self, context):
        ...
        try:
            if obj.modifiers["ConvexHullBrush"]:
                material = obj.modifiers["ConvexHullBrush"]["Socket_2"]
                obj.modifiers["ConvexHullBrush"]["Socket_3"] = 1.0
